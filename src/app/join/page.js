...
const Join = () => {
  return (
    <div className="w-full flex flex-col items-center min-h-screen mb-[20%]">
      ...
      <p className="text-robosub-light-blue text-lg md:text-4xl 2xl:text-6xl font-semibold text-center">
        We are Currently Recuiting for ALL
      </p>
      <p className="text-robosub-light-blue text-lg md:text-4xl 2xl:text-6xl font-semibold text-center mb-10 2xl:mb-16">
        Subteams!
      </p>
      <Button
        text="Join Discord"
