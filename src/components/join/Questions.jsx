...
const Questions = () => {
  ...
  return (
    <div ref={ref} className="mt-6 md:mt-3 w-[95%] md:w-3/4 ">
      {questions.map((item, index) => (
        <div key={index} className="flex ml-[7%] justify-between pb-[4%]">
          <div
            ...
            ${inView && "animate-fade-right animate-ease-in-out"} ${
              inView && item.animation
            }`}
            key={index}
          >
            {item.question}
          ...
          <div
            ...
            ${inView && "animate-fade-left animate-ease-in-out"} ${
              inView && item.animation
            }`}
            key={index}
          >
