...
const Footer = () => {
  return (
    <div className="w-full px-10 bg-white md:h-[33vh] md:flex md:my-0 my-10 justify-between font-sans relative">
      <Image
        alt="img1"
        src={img1}
        className="md:w-screen absolute md:left-0 bottom-1/3 -z-10"
      />
      <Link
        href="/"
      ...
      <div className="flex flex-col justify-center items-center text-robosub-black text-xl my-5 md:my-0">
      ...
      <div className="flex justify-end">
        <div className="flex items-center text-robosub-black">
          ...
          <div className="text-5xl border-l-black border-l-2 pl-6 ml-7 mb-5 md:mb-0 flex flex-col items-end">
