const format =
  "rounded-xl border-robosub-yellow border-[1px] flex flex-col items-center  w-[31%] py-2 pb-4 border-opacity-70 text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-500";
  ...
  return (
    <div className=" w-1/2">
      <div className="flex flex-col items-center">
        ...
        <p class="font-bold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-500 text-[90px] leading-none">
          2015
        </p>
      </div>
